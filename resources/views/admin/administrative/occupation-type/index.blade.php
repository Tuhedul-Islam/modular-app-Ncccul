        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Occupation Type</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
            ...
            <form class="" method="POST" action="{{route('admin.administrative.occupation-type.store')}}">
                <!-- Modal -->
                @csrf
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title"><i class="bi bi-plus-circle"></i> Create Occupation Type</h5>
                    ...
                    <tbody>
                        @foreach ( $occupationTypes as $occupationType )
                            <tr>
                                ...
                                <td>{{ $occupationType->priority ?? 1 }}</td>
                                <td>{{$occupationType->name ?? ''}}</td>
                                <td>{!! $occupationType->status == 1
                                ...
                                !!}
                                 ...
                                 <td class="d-flex gap-1 justify-content-center">
                                    ...
                                    <form method="POST" action="{{ route('admin.administrative.occupation-type.update', $occupationType->id) }}">
                                        @csrf
                                        @method('PUT')
                                        <div class="modal fade large_modal" id="exampleLargeModal{{ $loop->iteration }}" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"><i class="bi bi-pencil-square"></i> Edit Occupation Type</h5>
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-danger fs-15  btn-sm" onclick="deleteData('Occupaton Type','{{ route('admin.administrative.occupation-type.destroy') }}', {{$occupationType->id}});">
