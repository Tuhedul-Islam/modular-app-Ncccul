...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            ...
            <form class="" method="POST" action="{{route('admin.administrative.district.store')}}">
                <!-- Modal -->
                @csrf
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title"><i class="bi bi-plus-circle"></i> Create District</h5>
                    ...
                    <tbody>
                        @foreach ( $districts as $district )
                            <tr>
                                ...
                                <td>{{ $district->priority ?? 1 }}</td>
                                <td>{{{$district->name ?? ''}}}</td>
                                <td>{{ $district->division->name ?? '' }}</td>
                                <td>{!! $district->status == 1
                                ...
                                !!}
                                 ...
                                 <td class="d-flex gap-1 justify-content-center">
                                    ...
                                    <form method="POST" action="{{ route('admin.administrative.district.update', $district->id) }}">
                                        @csrf
                                        @method('PUT')
                                        <div class="modal fade large_modal" id="exampleLargeModal{{ $loop->iteration }}" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"><i class="bi bi-pencil-square"></i> Edit District</h5>
                                                                ...
                                                                <div class="p-3 rounded">
                                                                    ...
                                                                    <div class="col-12 mb-3">
                                                                        <x-common.select
                                                                            ...
                                                                            :showSymbol="false" 
                                                                            {{-- :options="$divisions->pluck('name', 'id')->toArray()" --}}
                                                                            :options="$district->division ? [$district->division->name] : []"
                                                                            class="single-select"
                                                                            value="1"
                                                                        />
                                                                    </div>
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-danger fs-15  btn-sm" onclick="deleteData('District','{{ route('admin.administrative.district.destroy') }}', {{$district->id}});">
