...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            ...
            <form class="" method="POST" action="{{route('admin.administrative.user-type.store')}}">
                <!-- Modal -->
                @csrf
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title"><i class="bi bi-plus-circle"></i> Create User Type</h5>
                    ...
                    <tbody>
                        @foreach ( $user_types as $user_type )
                            <tr>
                                ...
                                {{-- <td>{{$loop->iteration}}</td> --}}
                                <td>{{ $user_type->priority ?? 1 }}</td>
                                <td>{{{$user_type->name ?? ''}}}</td>
                                <td>{!! $user_type->status == 1
                                ...
                                !!}
                                 ...
                                 <td class="d-flex gap-1 justify-content-center">
                                    ...
                                    <form method="POST" action="{{ route('admin.administrative.user-type.update', $user_type->id) }}">
                                        @csrf
                                        @method('PUT')
                                        <div class="modal fade large_modal" id="exampleLargeModal{{ $loop->iteration }}" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"><i class="bi bi-pencil-square"></i> Edit User Type</h5>
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-danger fs-15  btn-sm" onclick="deleteData('User Types','{{ route('admin.administrative.user-type.destroy') }}', {{$user_type->id}});">
