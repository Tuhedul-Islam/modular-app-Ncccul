...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            ...
            <form class="" method="POST" action="{{route('admin.administrative.division.store')}}">
                <!-- Modal -->
                @csrf
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title"><i class="bi bi-plus-circle"></i> Create Division</h5>
                    ...
                    <tbody>
                        @foreach ( $divisions as $division )
                            <tr>
                                ...
                                <td>{{ $division->priority ?? 1 }}</td>
                                <td>{{{$division->name ?? ''}}}</td>
                                <td>{!! $division->status == 1
                                ...
                                !!}
                                 ...
                                 <td class="d-flex gap-1 justify-content-center">
                                    ...
                                    <form method="POST" action="{{ route('admin.administrative.division.update', $division->id) }}">
                                        @csrf
                                        @method('PUT')
                                        <div class="modal fade large_modal" id="exampleLargeModal{{ $loop->iteration }}" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"><i class="bi bi-pencil-square"></i> Edit Division</h5>
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-danger fs-15  btn-sm" onclick="deleteData('Division','{{ route('admin.administrative.division.destroy') }}', {{$division->id}});">
