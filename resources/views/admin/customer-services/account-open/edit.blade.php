  ...
  <div class="custom-page-content">
    <div class="row">
      <div class="col-xl-12 mx-auto position-relative">
        ...
        <div class="card">
          <div class="card-body">
            <form action="{{route('account-open.update',$id)}}" method="POST" name="form1"  >
              ...
              <div class="row">
                   ...
                   <x-common.input
                    ...
                    column="2"
                    type="date"
                    value="{{$account_open->accounts_open_date}}"
                  ...
                  <x-common.input
                    ...
                    name="accounts_id"
                     :required="true"
                    value="{{$account_open->accounts_id}}"
                  ...
                  <x-common.select
                        ...
                        :required="true"
                        value="{{$account_open->accounts_type_id}}"
                        class="single-select"
                        :options="[
                            '1' => 'Credit',
                            '2' => 'Savings',
                              ...
                              <div class="col-xl-12">
                                <div class="row">
                                  <x-common.input
                                    ...
                                    name="document_no"
                                    readonly
                                    value="{{$account_open->document_no}}"
                                  />
                                  ...
                                  <x-common.input
                                    ...
                                    readonly
                                    value="{{$account_open->document_ref_no}}"
                                  />
                                  ...
                                  <div class="col-xl-12">
                                    <div class="row">
                                        ...
                                        <x-common.input
                                          ...
                                          value="{{$account_open->acc_name_bn}}"
                                        />
                                        ...
                                        <x-common.input
                                          ...
                                          column="3"
                                          name="father_name"
                                          value="{{$account_open->father_name}}"
                                        />
                                         ...
                                         <x-common.input
                                          ...
                                          column="3"
                                          name="mother_name"
                                          value="{{$account_open->mother_name}}"
                                        />
                                         ...
                                         <x-common.input
                                          ...
                                          column="3"
                                          name="spouse_name"
                                          value="{{$account_open->spouse_name}}"
                                        />
                                        ...
                                        <x-common.select
                                            ...
                                            :required="true"
                                            value="{{$account_open->marital_status_id}}"
                                            class="single-select"
                                            :options="[
                                                '' => '--select--',
                                                '1' => 'Others',
                                        ...
                                        <x-common.input
                                          ...
                                          :required="true"
                                          class="datepicker"
                                          value="{{$account_open->date_of_birth}}"
                                        />
                                        ...
                                        <x-common.select
                                          ...
                                          name="nationality"
                                          :required="true"
                                          value="{{$account_open->nationality}}"
                                          :options="[
                                        ...
                                        <x-common.input
                                            ...
                                            value="{{$account_open->birth_certificate_no}}"
                                          />
                                          ...
                                          name="blood_group"
                                          class="single-select"
                                          value="{{$account_open->blood_group}}"
                                          :options="[
                                              '' => '--select--',
                                              '1' => 'Other',
                                              '2' => 'A+',
                                        ...
                                        <x-common.select
                                          ...
                                          column="3"
                                          name="religion_id"
                                          value="{{$account_open->religion_id}}"
                                          :options="[
                                              '1' => 'Cristian',
                                              '2' => 'Other',
                                          ]"
                                        ...
                                        <x-common.input
                                          ...
                                          column="3"
                                          name="domination_id"
                                          value="{{$account_open->domination_id}}"
                                        />
                                        ...
                                        <x-common.input
                                          ...
                                          value="{{$account_open->church_name_area}}"
                                        />
                                        ...
                                        <x-common.input
                                          ...
                                          column="3"
                                          name="church_phone"
                                          value="{{$account_open->church_phone}}"
                                        />
                                        ...
                                        <x-common.input
                                          ...
                                          value="{{$account_open->occupation_type_id}}"
                                        />
                                        ...
                                        <x-common.input
                                          ...
                                          column="3"
                                          name="designation"
                                          value="{{$account_open->designation}}"
                                        />
                                        ...
                                        <x-common.input
                                          ...
                                          value="{{$account_open->office_name_address}}"
                                        />
                                        ...
                                        <x-common.input
                                          ...
                                          value="{{$account_open->office_phone_no}}"
                                        />
                                    ...
                                    <div class="row">
                                       ...
                                       <x-common.input
                                        ...
                                        <x-common.input
                                          ...
                                          column="3"
                                          name="union_phone_no"
                                          value="{{$account_open->union_phone_no}}"
                                        />
                                        ...
                                        <x-common.textarea
                                          ...
                                          rows="1"
                                          value="{{$account_open->comments_description}}"
                                        />
                                        ...
                                        <x-common.input
                                          ...
                                          value="{{$account_open->union_accounts_no}}"
                                        />
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  <div class="col-xl-12">
                                    <div class="row">
                                        ...
                                        <x-common.input
                                          ...
                                          value="{{$account_open->present_address_hn}}"
                                        />
                                        ...
                                        <x-common.input
                                          ...
                                          value="{{$account_open->present_address_vil}}"
                                       />
                                        ...
                                        <x-common.input
                                          ...
                                          value="{{$account_open->present_address_ps}}"
                                        />
                                        ...
                                        <x-common.input
                                          ...
                                          value="{{$account_open->present_address_pc}}"
                                        />
                                        ...
                                        <x-common.input
                                          ...
                                          value="{{$account_open->present_address_rd}}"
                                        />
                                        ...
                                        <x-common.input
                                          ...
                                          value="{{$account_open->present_address_po}}"
                                        />
                                         ...
                                         <x-common.input
                                          ...
                                          value="{{$account_open->present_address_dist}}"
                                        />
                                         ...
                                         <x-common.input
                                          ...
                                          value="{{$account_open->present_address_hp}}"
                                        />
                                  ...
                                  <div class="col-xl-12">
                                    <div class="row">
                                        <x-common.input
                                          ...
                                          value="{{$account_open->permanent_address_hn}}"
                                        />
                                        ...
                                        <x-common.input
                                          ...
                                          value="{{$account_open->permanent_address_vil}}"
                                      />
                                      ...
                                      <x-common.input
                                          ...
                                          value="{{$account_open->permanent_address_ps}}"
                                      />
                                      ...
                                      <x-common.input
                                          ...
                                          value="{{$account_open->permanent_address_pc}}"
                                      />
                                      ...
                                      <x-common.input
                                          ...
                                          value="{{$account_open->permanent_address_rd}}"
                                      />
                                      ...
                                      <x-common.input
                                          ...
                                          value="{{$account_open->permanent_address_po}}"
                                      />
                                      ...
                                      <x-common.input
                                          ...
                                          value="{{$account_open->permanent_address_dist}}"
                                      />
                                      <x-common.input
                                          label="Home Phone"
                                          column="3"
                                          name="permanent_address_hp"
                                          value="{{$account_open->permanent_address_hp}}"
                                      />
                                    ...
                                    <div class="col-xl-12">
                                      <div class="row">
                                          ...
                                          <x-common.input
                                              ...
                                              column="3"
                                              name="nominee_name_1"
                                              value="{{$account_open->nominee_name_1}}"
                                          />
                                          ...
                                          <x-common.input
                                              ...
                                              value="{{$account_open->nom_fathers_name_1}}"
                                          />
                                          ...
                                          <x-common.input
                                              ...
                                              value="{{$account_open->nom_mothers_name_1}}"
                                          />
                                            ...
                                            <x-common.input
                                              ...
                                              column="3"
                                              name="nom_address_1"
                                              value="{{$account_open->nom_address_1}}"
                                          />
                                        ...
                                        <div class="col-xl-3">
                                            <div class="mb-3 nid-group">
                                              <label class="form-label">NID No. <span class="text-danger">*</span></label>
                                              <input type="text" name="nid" class="form-control nid_number" placeholder="text" value="{{$account_open->nid}}" >
                                         ...
                                         <x-common.input
                                              ...
                                              column="3"
                                              name="nom_relation_1"
                                              value="{{$account_open->nom_relation_1}}"
                                          />
                                      </div>
                                      ...
                                      <div class="row">
                                        ...
                                        <x-common.input
                                              ...
                                              column="3"
                                              name="nominee_name_2"
                                              value="{{$account_open->nominee_name_2}}"
                                          />
                                          ...
                                          <x-common.input
                                              ...
                                              value="{{$account_open->nom_fathers_name_2}}"
                                          />
                                          ...
                                          <x-common.input
                                              ...
                                              value="{{$account_open->nom_mothers_name_2}}"
                                          />
                                            ...
                                            <x-common.input
                                              ...
                                              column="3"
                                              name="nom_address_2"
                                              value="{{$account_open->nom_address_2}}"
                                          />
                                        ...
                                        <div class="col-xl-3">
                                          ...
                                          <x-common.input
                                              ...
                                              column="3"
                                              name="nom_relation_2"
                                              value="{{$account_open->nom_relation_2}}"
                                          />
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-xl-12">
                                    <div class="row">
                                       <x-common.input
                                              ...
                                              value="{{$account_open->introducer_id_1}}"
                                        />
                                         ...
                                         <x-common.input
                                              ...
                                              value="{{$account_open->intro_account_name_1}}"
                                        />
                                        ...
                                        <x-common.select
                                            ...
                                            value="{{$account_open->intro_accounts_type_id_1}}"
                                            :required=true
                                            :options="[
                                                '1' => 'Business',
                                                '2' => 'Student',
                                      ...
                                      <x-common.input
                                        ...
                                        />
                                         ...
                                         <x-common.input
                                              ...
                                              value="{{$account_open->intro_account_name_2}}"
                                        />
                                        ...
                                        <x-common.select
                                            ...
                                            :value="'Gender'"
                                            class="single-select"
                                            value="{{$account_open->intro_accounts_type_id_2}}"
                                            :options="[
                                                '1' => 'Business',
                                                '2' => 'Student',
                                                '3' => 'Employee',
              ...
              <div class="submit-button">
                  <button type="button" class="btn btn-primary px-5" onclick="window.open('{{route('account-open.list')}}','_top');">List</button>
